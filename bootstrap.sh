...
# Set up the database
echo "CREATE DATABASE IF NOT EXISTS theCotery" | mysql
echo "CREATE USER 'Kyle-Admin'@'localhost' IDENTIFIED BY ''" | mysql
echo "GRANT ALL PRIVILEGES ON theCotery.* TO 'theCotery'@'localhost' IDENTIFIED BY ''" | mysql
